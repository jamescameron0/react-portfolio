  ...
  <section className={styles.container}>
    <div className={styles.content}>
        ...
        <p className={styles.description}>
            I'm a 4th year Computer Engineering & Management Student at McMaster University. 
    ...
    <img className = {styles.heroImg} src="assets/hero/headshot.png" alt="image of me"></img>
  </section>
  );
};